...
(doom! :input
       ...
       :emacs
       (dired +ranger)             ; making dired pretty [functionul]
       ...
       (org +contacts +dragndrop +gnuplot +journal +hugo +pandoc +present +roam2 +pomodoro)               ; organize your plain life in plain text
